...
- [x] **Test Production Build**: Run `./prepare-deploy.sh` and verify the resulting archive.
- [x] **Server Production Mode**: Ensure the server uses the `dist` folder or specific production logic when `NODE_ENV=production`.
